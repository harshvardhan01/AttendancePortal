...
<html>
    ...
    <body>
        <ul>
            ...
            <li class="dropdown">
                <a href="javascript:void(0)" class="dropbtn">Co-ordinator</a>
                <div class="dropdown-content">
                    <a href="AddCoordinator.php">Add Co-ordinator</a>
                    <a href="ViewCoordinator.php">View Co-ordinator</a>
                </div>
            </li>
            <li class="dropdown">
            ...
            <li class="dropdown">
                ...
                <div class="dropdown-content">
                    ...
                    <a href="ViewBranches.php">View Branches</a>
                </div>
            </li>
